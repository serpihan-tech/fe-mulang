...
export default function DetailNotif () {
  return (
    <div className="w-full bg-neutral-50 min-h-screen space-y-[18px] p-10">
      ...
      <div className="w-full flex justify-center">
        <div className="w-2/3 p-10 bg-white rounded-[10px] outline outline-1 outline-offset-[-1px] outline-[#adc0f5]">
          <div className="w-full space-y-8">
            ...
            <div className="flex px-4 py-2.5 bg-[#f3f3f3] rounded-[10px] justify-between items-center">
              <div className="flex space-x-[22px] items-center">
                <Document size={76} color="#dc1010" variant="Bulk"/>
