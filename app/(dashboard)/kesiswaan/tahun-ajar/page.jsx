        ...
        <div>
          <div className="w-full ps-2">
            <div className="flex items-center">
              <h1 className="w-full text-black dark:text-slate-100 text-xl font-semibold">Data Semester</h1> 
            ...
            <div className="flex flex-col justify-end bg-white dark:bg-dark_net-pri rounded-lg my-5">
              <div className={SemesterData ? "max-w-screen-xl p-2 lg:p-5 dark:bg-dark_net-ter" : "flex items-center justify-center text-black dark:text-white p-28"}>
                  {SemesterData ? 
                    <TableComponent 
                        columns={columns} 
                        data={SemesterData} 
