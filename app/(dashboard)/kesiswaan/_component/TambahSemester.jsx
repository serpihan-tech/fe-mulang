    ...
    <div className="w-[485px] bg-white pb-8 rounded-lg">
      ...
      <div className="w-full px-5">
        ...
        <div className={`space-y-1 w-full font-medium ${formData.id ? "" : "hidden"}`}>
            <label className="text-black text-sm font-medium">ID Semester</label>
            <input
              disabled
              type="text"
              value={formData.id ?? ""}
              //onChange={(e) => setFormData({ ...formData, id: e.target.value })}
              className={`w-full h-10 p-2 text-sm text-black font-medium rounded-md bg-netral-20 border border-netral-2`}
            />
          </div>
          ...
          <div className="space-y-1 w-full font-medium">
            ...
            <input
              ...
              className={`w-full h-10 p-2 text-sm font-medium rounded-md bg-white border border-netral-20 focus:outline-pri-main ${
                    formData.tahunAjar ? "text-black" : "text-netral-20"
                }`}
            />
          </div>
            ...
            <div className="flex-1 space-y-1 font-medium">
              ...
              <CustomDatePicker
                ...
                customFilterdateStyle={`flex items-center justify-between border border-netral-20 focus:outline-pri-main rounded-lg px-4 py-2 cursor-pointer min-w-[180px] ${
                    formData.date_start ? "text-black" : "text-netral-20"
                }`}
                />
            </div>
            <div className="flex-1 space-y-1 font-medium">
              ...
              <CustomDatePicker
                ...
                customFilterdateStyle={`flex items-center  justify-between border border-netral-20 rounded-lg px-4 py-2 cursor-pointer min-w-[180px] ${
                    formData.date_end ? "text-black" : "text-netral-20"
                }`}
                />
            </div>
          </div>
          ...
          <div className="space-y-1">
            ...
            <Dropdown
              ...
              className="w-full h-10 p-2 rounded-md bg-white border border-netral-20"
          ...
          <div className="w-full flex justify-end space-x-4 pt-2">
            <button
              type="button"
              onClick={onCancel}
              className="w-[103px] h-[38px] px-2 py-1.5 text-sm font-medium border rounded-md border-err-main text-err-main hover:bg-err-main hover:text-white bg-white transition-shadow duration-300 hover:shadow-md"
            >
              Batal
            </button>
            <button
              ...
              className={`w-[103px] h-[38px] px-2 py-1.5 rounded-md text-white text-sm font-medium ${
                isLoading
                  ...
                  : "bg-pri-main hover:bg-pri-hover"
