...
export default function NotificationTeacher () {
  return (
    <div className="w-full bg-neutral-50 dark:bg-dark_net-pri p-2 md:-4 lg:p-8 min-h-screen">
      <h1 className="text-black dark:text-slate-100 text-xl font-semibold">Notifikasi</h1>
