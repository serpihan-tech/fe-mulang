      ...
      <div className={`w-full ${contentGap}`}>
        <div className="w-full flex justify-between items-center">
          <div className="flex items-center"> 
            <h2 className="justify-center text-blue-700 dark:text-[#5D8BF8] text-sm md:text-base lg:text-lg font-bold">
              {sender}
            </h2>
            {renderAdditionalInfo()}
          </div>
          <div className="flex gap-1">
            <div className="text-black dark:text-slate-100 text-xs font-normal">{date}</div>
