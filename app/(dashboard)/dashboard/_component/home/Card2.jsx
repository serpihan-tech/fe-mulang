...
export default function Card2({ icon: Icon, value, label, bgColor, colorBehind }) {
  return (
    <div className={`w-full flex px-2.5 py-2 md:px-3 md:py-3 lg:px-4 lg:py-6 rounded-[15px] lg:rounded-[20px] ${bgColor} items-center`}>
        {/* Icon */}
        ...
        {/* Nominal Data */}
          <p className="text-sm md:text-base lg:text-lg font-semibold text-gray-900">{label}</p>

          {/* Keterangan */}
          <p className="text-sm md:text-base lg:text-lg font-semibold text-gray-900">{value}</p>
        </div>
    </div>
  );
}
